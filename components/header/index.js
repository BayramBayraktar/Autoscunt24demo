...
const Header = () => {
  ...
  const [LanguageVisibiltiy, setLanguageVisibility] = useState(false)
      ...
      <Container>
        ...
        <Navigation >
          <NavigationList>
            <NavigationListİtem>
              <Link href="/">
                <a>{t("home:UsedAndNewCars")}</a>
              </Link>
            </NavigationListİtem>
            <NavigationListİtem>
              <Link href="/motorbices">
                <a>{t("home:MotorBikes")}</a>
              </Link>
            </NavigationListİtem>
            <NavigationListİtem>
              <Link href="https://truckscout24.com">
                <a>{t("home:Trucks")}</a>
              </Link>
            </NavigationListİtem>
          </NavigationList>
        ...
        <LanguageSection>
          <ButtonLanguage onClick={() => setLanguageVisibility(true)}>
            {t("home:Language")}
            <DropDown src="/Drop.png" />
          </ButtonLanguage>
          <OutsideClickHandler onOutsideClick={() => setLanguageVisibility(false)}>
            {LanguageVisibiltiy &&
              <LanguageList>
                {Countrys.map(Country => (
                    <LanguageListItem onClick={() => setLang(Country.LocalName)}>
                      <Link href={router.pathname} locale={Country.LocalName}>
                        <CountryTitle imgUrl={Country.Flag} className={router.locale === Country.LocalName ? 'Active' : ""}>{Country.title}</CountryTitle>
                      </Link>
                    </LanguageListItem>))}
              </LanguageList>}
          </OutsideClickHandler>
        </LanguageSection>
        <MobileBar onClick={() => setToggleMobileMenu(!ToggleMobileMenu)}>
          Menu
        </MobileBar>
      </Container>
      <NavigationList className={!ToggleMobileMenu ? 'MobileActive' : ""}>
        <NavigationListİtem>
          <Link href="/">
            <a>{t("home:UsedAndNewCars")}</a>
          </Link>
